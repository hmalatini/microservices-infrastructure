...
class CronJobClient {
    ...
    List<CronJobDTO> getCronJobs(String serviceName, String envName) {
        HttpEntity<String> entity = new HttpEntity<>(getHeaders());
        ResponseEntity<List<CronJobDTO>> response = restTemplate.exchange(
            getURI("/backend/" + serviceName + "/" + envName + "/cronjob", Collections.emptyMap()), HttpMethod.GET,
