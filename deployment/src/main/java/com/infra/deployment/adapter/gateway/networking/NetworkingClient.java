...
class NetworkingClient {
    ...
    NetworkingDTO getNetworking(String serviceName, String envName) {
        HttpEntity<String> entity = new HttpEntity<>(getHeaders());
        ResponseEntity<NetworkingDTO> response = restTemplate.exchange(
            getURI("/backend/" + serviceName + "/" + envName + "/networking", Collections.emptyMap()), HttpMethod.GET,
            entity, NetworkingDTO.class);
